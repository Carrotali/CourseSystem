...
/*
 * 类名：TeacherInforData 
 * 功能：实现TeacherInforDataService接口
 * 
 */
public class TeacherInforData extends UnicastRemoteObject implements TeacherInforDataService{

	public TeacherInforData() throws RemoteException {
		super();
	 ...
	 * 功能：读出教师数据
	 * (non-Javadoc)
	 * @see busninesslogic.TeacherInforDataService#read()()
	 */
	@Override
	public ArrayList<String> read() throws RemoteException {
		File courseList = new File("teacherInfor");
	 ...
	 * 功能：查找教师
	 * (non-Javadoc)
	 * @see busninesslogic.TeacherInforDataService#find()()
	 */
	@Override
	public String find(String id) throws RemoteException {
		Boolean isExist=false;
		BufferedReader reader = null;
		File userList = new File("teacherInfor");
		ArrayList<String> list=new ArrayList<String>();
		try {
	 ...
	 * 功能：更新教师数据
	 * (non-Javadoc)
	 * @see busninesslogic.TeacherInforDataService#update()()
	 */	
	public Boolean update(String input) throws RemoteException {
		...
		int i = 0;
		 ...
		 FileWriter fw = null;
			try {
				fw = new FileWriter("teacherInfor");
			} catch (IOException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
...
//				System.out.println(list.get(j));
	 ...
	 * 功能：删除教师
	 * (non-Javadoc)
	 * @see busninesslogic.TeacherInforDataService#delete()
	 */
...
//					System.out.println(list.get(j));
	 ...
	 * 功能：新增教师数据
	 * (non-Javadoc)
	 * @see busninesslogic.TeacherInforDataService#add()()
	 */
